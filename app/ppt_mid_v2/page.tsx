...
export default function PresentationPage() {
  ...
  const currentSlideSrc = `/ppt_mid_v2/${slideFiles[currentSlideIndex]}` // Updated path
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow px-4 py-8 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-8 text-center text-gray-800">중간 발표 자료 V2</h1>
